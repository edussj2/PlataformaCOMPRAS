    ...
    <div class="lista-opciones">
        <div class="opcion">
            <a href="<?php echo SERVERURL; ?>documentNew/" class="text-gray-700 h5 text-uppercase activo">
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-5">
                <div class="card-body">
                    ...
                    <!-- Formulario -->
                    <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/documentoAjax.php" method="POST" data-form="save" autocomplete="off">
                            <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group bmd-form-group">
                                                <label for="documento_nombre">Descripción &nbsp; <i class="fab fa-font-awesome-alt"></i> &nbsp;</label>
                                                <input type="text" pattern="[a-zA-Z0-99áéíóúÁÉÍÓÚñÑ ]{3,40}" class="form-control" name="documento_nombre_reg" id="documento_nombre" maxlength="40">
                                            </div>
                                        </div>

                                        <div class="col-12 col-md-6">
                                            <div class="form-group bmd-form-group is-filled">
                                                <label for="documento_estado">Estado del Documento</label>
                                                <select class="form-control" name="documento_estado_reg" id="documento_estado">
