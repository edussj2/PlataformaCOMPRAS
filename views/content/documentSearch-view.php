<?php
    ...
    <div class="lista-opciones">
        ...
        <div class="opcion">
            <a href="<?php echo SERVERURL; ?>documentList/" class="text-gray-700 h5 text-uppercase">
                <i class="fas fa-list"></i> &nbsp; Lista 
            </a>
        </div>
        <div class="opcion">
            <a href="<?php echo SERVERURL; ?>documentSearch/" class="text-gray-700 h5 text-uppercase activo"> 
    ...
    <?php 
	    if(!isset($_SESSION['busqueda_documentos']) && empty($_SESSION['busqueda_documentos'])):
    ?>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-6">
                        <div class="form-group bmd-form-group">
                            <input type="text" class="form-control" name="busqueda_documentos" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" id="inputSearch" maxlength="30" placeholder="¿Qué documento estas buscando?">
                        </div>
                    </div>
                    <div class="col-12">
                        <p class="text-center">
    ...
    <div class="container-fluid pt-5 pb-4 border-left-danger border mb-2">
        <form class="FormularioAjax" action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" data-form="search" method="POST" autocomplete="off">
            <input type="hidden" name="eliminar_busqueda_documentos" value="1">
            <div class="container-fluid">
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-6">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>“<?php echo $_SESSION['busqueda_documentos'];?>”</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        <?php 
			...
			echo $insDocumento->paginador_documento_controlador($pagina[1],10,$_SESSION['busqueda_documentos']);
		?>
    </div>
    <!-- Lista -->
